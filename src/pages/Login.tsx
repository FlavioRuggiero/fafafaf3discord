    ...
    <div className="min-h-screen flex items-center justify-center bg-[#313338] p-4 font-sans">
      ...
      <div className="w-full max-w-[480px] bg-[#313338] md:bg-[#2b2d31] md:p-8 rounded-lg md:shadow-lg">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-[#23a559] text-center mt-2 font-medium bg-[#23a559]/10 py-2 rounded">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-[3px] h-11 transition-colors mt-3"
          >
