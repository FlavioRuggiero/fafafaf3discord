...
export const Avatar = ({ src, alt, className = "", decoration, isSpeaking, clipEffects }: AvatarProps) => {
  ...
  // Usiamo left/top/width/height invece di transform per non creare un nuovo stacking context
  // Questo permette agli elementi 3D di passare correttamente dietro l'avatar (z-index: 10)
