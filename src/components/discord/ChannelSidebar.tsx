                                  ...
                                  <div className="w-full">
                                    <ProfilePopover user={userForCard} side="right" align="center">
                                      <div className="flex items-center group/member animate-in fade-in-0 zoom-in-95 duration-300 cursor-pointer">
                                        <div className={`relative rounded-full transition-all duration-100 ${showSpeakingRing ? 'ring-2 ring-yellow-500' : 'ring-2 ring-transparent'}`}>
                                          <Avatar src={member.profiles?.avatar_url || `https://api.dicebear.com/7.x/avataaars/svg?seed=${member.user_id}`} decoration={member.profiles?.avatar_decoration} className="w-6 h-6 bg-[#1e1f22]" />
                                          <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-[#2b2d31] bg-[#23a559] z-50" />
                                        </div>
